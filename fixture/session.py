...
class SessionHelper:
    ...
    def is_logged_in_as(self, username):
        wd = self.app.wd  # понадобиться ссылка на драйвер
        return wd.find_element_by_xpath("//div[@id='top']/form/b").text == "("+username+")"  # у найденного элемента нужно взять текст. этот текст надо стравнить с именем пользователя, но взятое в круглые скобки
